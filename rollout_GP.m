...
%     gravity_control = solveInverseDynamics(dyn.robot.A, dyn.robot.M, stateTojoint(s(plant.jointi)), zeros(length(plant.jointi),1), zeros(length(plant.jointi),1), dyn.robot.G, Vdot_0_control)';
