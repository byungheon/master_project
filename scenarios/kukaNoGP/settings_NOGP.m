...
%  1~3   q             angle of each joint
%  4~6   dq            angular velocity of each joint
...
dyno = [1 2 3 4 5 6];
angi = [1 2 3];
dyni = [4 5 6 7 8 9 10 11 12];
dyni_p = [1 2 3 4 5 6];
poli = [4 5 6 7 8 9 10 11 12];
difi = [1 2 3 4 5 6];
jointi = [1 2 3];
...
plant.dynamics = @dynamics_NOGP;           % handle to dynamics ODE function
...
plant.angstd = mu0(jointi);  % mid point of each joint angle (we need to wrap up each angle in midpoint - pi ~ midpoint + pi) 
...
cost.fcn = @loss_NOGP;                           % handle to cost function
